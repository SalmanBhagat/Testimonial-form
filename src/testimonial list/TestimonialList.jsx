              ...
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    Sapiente qui neque rerum laboriosam iure provident! In
                    accusamus aspernatur quae sit officiis omnis beatae! Natus
                    dolores a nobis aliquid ratione? Cum.
                  </p>
                </div>
                ...
                <div className="card-footer bg-white border-top-0">
                  <button className="btn btn-primary w-100" onClick={() => setOpen(true)}>Submit</button>
                </div>
              </div>
            </div>
          ))}
